...
export default class ReactAddToCalendar extends React.Component {
    ...
    renderDropdown() {
        ...
        return <div className={this.props.dropdownClass}>{items}</div>
    }
    ...
    renderButton() {
        ...
        if (template[0] !== 'textOnly') {
            ...
            buttonLabel = (
                <Fragment>
                    {buttonLabel}
                    <span style={{ marginLeft: '4px' }}>{buttonIcon}</span>
                </Fragment>
            )
        }
        ...
        return (
            <div className={this.props.buttonWrapperClass}>
                <div className={buttonClass + ''} onClick={this.toggleCalendarDropdown}>
                    {buttonLabel}
                </div>
            </div>
        )
